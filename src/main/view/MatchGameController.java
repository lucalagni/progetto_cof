...
public class MatchGameController extends FxmlMatchGameController {
    ...
    public static final Integer VILL_A = 0;
    public static final Integer VILL_B = 1;

    public static final Integer CX = 0;
    public static final Integer CY = 1;
    public static final Integer[][] PUNTI = {
        {98, 103}, // A
        {90, 220}, // B
        {210,141}, // C
        {204, 240}, // D
...
//            
    ...
    public void mapLine() {
        // inizializzazione struttura strade
        roots = new ArrayList<>();

        // connessioni strade
        int[][] conn = matchNew.getBoard().getGameMap().getConnections();

        for (int i = 1; i < conn.length; i++) {
            for (int j = 0; j < conn.length-1; j++) {
                // esce dal ciclo se NON i>j
                if (i <= j) {
                    continue;
                }
                ...
                int xStart = PUNTI[i][CX];
                int yStart = PUNTI[i][CY];
                ...
                l.setEndY(yEnd);
                l.setStrokeWidth(5);
                String style ="-fx-stroke: peru;"+  "-fx-opacity: 0.8;";
    ...
    /**
     * Setta il testo delle Label dei villaggi relativi alle carte permesso
     * delle regioni della Board
     *
    ...
    /**
     * Gestisce gli eventi dei pulsanti per spostare in avanti gli indici
     * relativi alle carte permesso
     *
     * @param e
     */
    @FXML
    ...
    /**
     * Gestisce i bottoni per spostare indietro gli indici relativi alle carte
     * permesso
     *
     * @param e
     */
    ...
    /**
     * Inserisce all'interno di un array multiplo di PermitCard le carte regione
     * scoperte relative alla board può essere usato per fare l'update
     */
    ...
    /**
     * Salva in un array le immagini delle carte politiche del giocatore facendo
     * un controllo tra i colori delle carte politiche del giocatore e i colori
     * stabiliti
     *
     * @param imgsPoliticalCards ArrayList di ImageView dove salvare le immagini
     * delle carte politiche del giocatore
     */
    ...
    // }
    /**
     * Crea una nuova HBox dove inserire le immagini delle carte politiche del
     * giocatore per mostrarle nella tabella dati
     */
    ...
    /**
     * Crea una nuova HBox dove inserire le immagini delle carte politiche per
     * l'azione principale costruisci emporio
     */
    ...
    /**
     * Seleziona le carte politiche per le azioni (gestisce l'interazione
     * grafica di selezione) le salva su un arrayList da mandare al server
     */
    ...
    /**
     * Selziona carte politiche per azione aiuto del re (gestisce l'interazione
    ...
    /**
     * Metodo che gestisce i "mouse clicked" sui bottoni per vedere gli empori
     * prensenti nei villaggi
     *
     * @param e evento
     */
    @FXML
...
//			selectRegionPermitCard1
     ...
     * @param nobil0 � il nobile in posizione 0 del balconcino
     * @param nobil1 � il nobile in posizione 1 del balconcino
     * @param nobil2 � il nobile in posizione 2 del balconcino
     * @param nobil3 � il nobile in posizione 3 del balconcino
     */
...
//		control = permitCard.verifyVillage(nameVillage);
     ...
     * @return default false, ritorna true se il giocatore ha un emporio in quel
     * villaggio
     */
        ...
        if ((e.getSource() == villageA11) == true) {
            ...
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Arkon";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageB11) == true) {
            ...
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Burgen";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageC11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Castrum";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageD11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Dorful";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageE11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Esti";
                }
            } else {
                errorMessage += "Hai gi�àselezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageF11) == true) {
            ...
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Framek";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageG11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Graden";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageH11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Hellar";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageI11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Indur";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageJ11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Juvelar";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageK11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Kultos";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageL11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Lyram";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageM11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Merkatim";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageN11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Naris";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
        ...
        if ((e.getSource() == villageO11) == true) {
            if (selectedVillageDoubleBonus[1] == " ") {
                if (selectedVillageDoubleBonus[0] == " ") {
                    ...
                    selectedVillageDoubleBonus[1] = "Osium";
                }
            } else {
                errorMessage += "Hai già selezionato due villaggi, fai la tua mossa\n";
            }
