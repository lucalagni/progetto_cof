...
public class Agent {
	...
	/**
	 * Quando il giocatore avviene la transizione di compra vendita, la carta permesso deve essere eliminata dalle propriet� del giocatore
	 * e devono essere aggiunti i coins relativi a  tale vendita.
	 * @param itemPermitCard � la carta che deve essere sottratta dalle propriet� del giocatore
	 * @throws GamerException
	 */
	public void sellPermitCard(ItemPermitCard itemPermitCard) throws GamerException{
		// vado a iterare l'array delle carte permesso non usate del giocatore per trovare il riscontro con quella che � stata venduta
	...
	/**
	 * Quando il giocatore avviene la transizione di compra vendita, la carta politica deve essere eliminata dalle propriet� del giocatore
	 * e devono essere aggiunti i coins relativi a  tale vendita.
	 * @param itemPoliticalcard � la carta che deve essere sottratta dalle prorpiet� del giocatore
	 * @throws GamerException
	 */
